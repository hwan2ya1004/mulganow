...
def shop_prices():
    ...
    ITEM_ALIAS_MAP = {
        ...
        # "닭고기"로 검색하면 매번 부위육(가슴살/다리살/목살 등)·조리식품(스테이크/
        # 술안주/치킨)만 나오고 생닭 자체가 안 나옴. "백숙닭"으로 검색하면 실제
        # 냉장 생닭/절단닭/토종닭 상품이 나와서(2026-07-21 확인) 이걸로 대체.
        "닭":       "백숙닭",   # 닭/목계, 닭/육계 등 → "백숙닭" 검색
        "계란":     "달걀",
        "보리":     "보리쌀",
        "밀":       "밀가루",
    }
    ...
    ITEM_MUST_INCLUDE = {
        ...
        "닭고기": ["닭고기", "닭", "치킨"],
        # 생닭(백숙/삼계용 통닭·절단닭)만 허용, 조리식품(치킨/스테이크 등)은 제외
        "백숙닭": ["백숙", "생닭", "토종닭", "삼계닭", "영계"],
        "우유":   ["우유"],
        "고등어": ["고등어"],
        "갈치":   ["갈치"],
        "오징어": ["오징어"],
    ...
    ITEM_EXCLUDE_KEYWORDS = {
        ...
        "돼지고기": ["돼지고기장조림", "삼겹살구이"],
        "닭고기": ["닭강정", "닭볶음탕", "닭볶음"],
        "백숙닭": ["삼계탕", "레토르트", "즉석", "곳간"],  # 완제품 삼계탕 국물류 제외, 생닭만 허용
        "계란":   ["계란찜", "계란말이", "계란장조림"],
        "고등어": ["고등어통조림", "고등어조림"],
        "갈치":   ["갈치조림"],
        "오징어": ["오징어채", "오징어볶음", "오징어젓"],
